    ...
    public Queue<Command> scriptRun(Command command) {
        ...
        try (InputStream scriptStream = new FileInputStream(new File(script.getScript()))) {
            ...
            JOptionPane.showMessageDialog(null,
                    bundle.getString("error_script_1"), bundle.getString("error_title"),JOptionPane.ERROR_MESSAGE);
            System.out.println("ОШИБКА СКРИПТА");
        } catch (IOException e) {
            JOptionPane.showMessageDialog(null,
                    bundle.getString("error_script_2"), bundle.getString("error_title"),JOptionPane.ERROR_MESSAGE);
